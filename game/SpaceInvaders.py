...
class SpaceInvaders():
    ...
    def get_state(self):
        ...
        """
        X_player = int(self.get_player_X())
        X_invader = int(self.get_indavers_X()[0])

        Y_player = int(self.get_player_Y())
        Y_invader = int(self.get_indavers_Y()[0])

        BULLET_State = 1 if self.get_bullet_state() == "rest" else 0

        return [X_player - X_invader, Y_player - Y_invader, BULLET_State]
